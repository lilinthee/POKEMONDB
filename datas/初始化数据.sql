...
/* 2. 道具数据：ITEMS
      INTRODUCTION 记录道具在游戏中的主要作用，整理自口袋妖怪百科对应道具页面的效果段。 */
insert into ITEMS (ITEM_NAME, INTRODUCTION)
select v.ITEM_NAME, v.INTRODUCTION
from
(
    values
    (N'伤药', N'选择１只同行宝可梦使用，让牠回复20ＨＰ；作为工艺制作的材料，可用来制作好伤药。'),
    (N'好伤药', N'选择１只同行宝可梦使用，让它回复６０ＨＰ；作为工艺制作的材料，可用来制作厉害伤药。'),
    (N'厉害伤药', N'选择１只同行宝可梦使用，让它回复１２０ＨＰ。'),
    (N'全复药', N'选择１只同行宝可梦使用，让牠回复所有ＨＰ，并且治愈牠的异常状态，以及治愈牠的混乱状态。'),
    (N'解毒药', N'选择１只处于中毒或剧毒状态的同行宝可梦使用，治愈它的中毒状态。'),
    (N'灼伤药', N'选择１只处于灼伤状态的同行宝可梦使用，治愈它的灼伤状态。'),
    (N'解冻药', N'选择１只处于冰冻状态的同行宝可梦使用，治愈它的冰冻状态。'),
    (N'解眠药', N'选择１只处于睡眠状态的同行宝可梦使用，治愈它的睡眠状态；对绝对睡眠特性的宝可梦无效。'),
    (N'解麻药', N'选择１只处于麻痹状态的同行宝可梦使用，治愈它的麻痹状态。'),
    (N'精灵球', N'捕获率 ×1；在包包中存在时，土居忍士进化时会分裂出脱壳忍者。进化后消耗。'),
    (N'超级球', N'捕获率×1.5。'),
    (N'高级球', N'捕获率×2。'),
    (N'雷之石', N'对 皮卡丘使用，使其进化为 雷丘 或 雷丘（阿罗拉）；对 伊布使用，使其进化为 雷伊布。'),
    (N'火之石', N'对 六尾使用，使其进化为 九尾；对 卡蒂狗使用，使其进化为 风速狗。'),
    (N'水之石', N'对 蚊香君使用，使其进化为 蚊香泳士；对 大舌贝使用，使其进化为 刺甲贝。'),
    (N'叶之石', N'对 臭臭花使用，使其进化为 霸王花；对 口呆花使用，使其进化为 大食花。'),
    (N'奇异甜食', N'对１只宝可梦使用，可使其等级提升１级。'),
    (N'木炭', N'携带该道具的宝可梦的火属性招式威力提升20%。'),
    (N'神秘水滴', N'携带该道具的宝可梦的水属性招式威力提升20%。'),
    (N'磁铁', N'携带该道具的宝可梦的电属性招式威力提升20%。'),
    (N'不变之石', N'携带该道具的宝可梦不会进化；小嘴蜗与盖盖虫连接交换时，任意一方携带该道具则双方都不会进化。'),
    (N'黑带', N'携带该道具的宝可梦的格斗属性招式威力提升20%。'),
    (N'硬石头', N'携带该道具的宝可梦的岩石属性招式威力提升20%。'),
    (N'纪念球', N'捕获率×1。'),
    (N'潜水球', N'若寶可夢在水中游泳而不在飛行中時，捕获率×3.5；否则捕获率×1。'),
    (N'巢穴球', N'若目标的等级为1至29级，则捕获率×（41-等级）/10，否则捕获率×1。'),
    (N'计时球', N'经过10回合后，捕获率×4；否则捕獲率×（1+0.3×回合数）。'),
    (N'豪华球', N'捕获率×1；通过豪华球收服的宝可梦在提升友好度时，获得的友好度+1。'),
    (N'治愈球', N'捕获率×1；通过治愈球捕获的宝可梦在被捕获时恢复全部的HP与异常状态。'),
    (N'先机球', N'若当前回合为对战开始的第一回合，捕获率×5，否则捕获率×1。'),
    (N'黑暗球', N'若当前位置为洞窟、新月岛，或当前为夜晚、闇夜时，捕获率×3，否则捕获率×1；若当前位置为陌生人之家、古代城的火神蛾房间，捕获率x1。'),
    (N'速度球', N'若目标的速度种族值≥100，捕獲率×4，否则捕獲率×1。'),
    (N'甜蜜球', N'若当前出战的宝可梦与目标处于同一进化家族中，且性别相异，捕获率×8，否则捕获率×1。'),
    (N'月之石', N'对 尼多娜使用，使其进化为 尼多后；对 尼多力诺使用，使其进化为 尼多王。'),
    (N'太阳之石', N'对 臭臭花使用，使其进化为 美丽花；对 向日种子使用，使其进化为 向日花怪。'),
    (N'觉醒之石', N'对 奇鲁莉安使用，使其进化为 艾路雷朵；对 雪童子使用，使其进化为 雪妖女。'),
    (N'光之石', N'对 波克基古使用，使其进化为 波克基斯；对 毒蔷薇使用，使其进化为 罗丝雷朵。'),
    (N'暗之石', N'对 黑暗鸦使用，使其进化为 乌鸦头头；对 梦妖使用，使其进化为 梦妖魔。'),
    (N'金属膜', N'特殊的金属膜。携带后，钢属性的招式威力就会提高。'),
    (N'升级数据', N'多边兽携带该道具连接交换进化为 多边兽Ⅱ；对 多边兽使用，使其进化为 多边兽Ⅱ。'),
    (N'王者之证', N'携带后进行攻击，在造成伤害时，有时会让对手畏缩。'),
    (N'生命宝珠', N'携带该道具的宝可梦的招式的威力提升；每次通过攻击招式命中对手，使用者损失最大ＨＰ的10%。'),
    (N'剩饭', N'携带该道具的宝可梦在每个回合结束时恢复最大ＨＰ的1/16。'),
    (N'气势披带', N'携带该道具的宝可梦在满ＨＰ时若被一击导致ＨＰ归零，则会保留1点ＨＰ而不进入濒死状态，使用一次后道具消失；携带该道具的宝可梦只能抵挡连续招式的第一次攻击。'),
    (N'力量头带', N'携带该道具的宝可梦的物理招式的威力提升10%。'),
    (N'博识眼镜', N'攜帶該道具的宝可梦的特殊招式的威力提升10%。'),
    (N'讲究头带', N'携带该道具的寶可夢的攻击提升50%，只能使用上場後使出的第一個招式；重新上场或重新获得道具时效果重置。'),
    (N'讲究眼镜', N'携带该道具的宝可梦的特攻提升50%，但只能使用上場後使出的第一個招式；重新上场或重新获得道具时效果重置。'),
    (N'讲究围巾', N'携带该道具的宝可梦的速度提升50%，只能使用上場後使出的第一個招式；重新上场或重新获得道具时效果重置。'),
    (N'进化奇石', N'携带该道具的宝可梦若是能进化的宝可梦，则其防御和特防提升50%；该道具对处于变身状态中的宝可梦是否生效取决于该宝可梦本身，而非其变成的宝可梦。防御和特防的提升量同样取决于变身前的宝可梦。'),
    (N'奇迹种子', N'携带该道具的宝可梦的草属性招式威力提升20%。'),
    (N'柔软沙子', N'携带该道具的宝可梦的地面属性招式威力提升20%。'),
    (N'毒针', N'携带后，毒属性招式的威力会提高。'),
    (N'咒术之符', N'携带该道具的宝可梦的幽灵属性招式威力提升20%。'),
    (N'弯曲的汤匙', N'携带该道具的宝可梦的超能力属性招式威力提升20%。'),
    (N'龙之牙', N'携带该道具的宝可梦的龙属性招式威力提升20%。'),
    (N'丝绸围巾', N'携带该道具的宝可梦的一般属性招式威力提升20%。'),
    (N'不融冰', N'携带该道具的宝可梦的冰属性招式威力会提升20%。'),
    (N'锐利鸟嘴', N'携带该道具的宝可梦的飞行属性招式威力提升20%。'),
    (N'银粉', N'携带该道具的宝可梦的虫属性招式威力提升20%。'),
    (N'电气球', N'让皮卡丘携带后，攻击和特攻的威力就会提高的神奇之球。'),
    (N'贝壳之铃', N'携带该道具的宝可梦在攻擊對方成功造成伤害时，携带者的ＨＰ會恢复其所造成伤害的1/8；强行特性的宝可梦携带该道具无效。'),
    (N'焦点镜', N'携带该道具的宝可梦的击中要害等级提升1级。'),
    (N'广角镜', N'携带该道具的宝可梦使出招式的命中率×1.1。'),
    (N'清净坠饰', N'光芒晶莹剔透的坠饰。携带后，不会因为对手的招式或特性而被降低能力。')
...
/* 4. 特性数据：ABILITIES
      INTRODUCTION 记录特性在游戏对战中的主要效果，整理自口袋妖怪百科对应特性页面。 */
insert into ABILITIES (ABILITY_NAME, INTRODUCTION)
select v.ABILITY_NAME, v.INTRODUCTION
from
(
    values
    (N'茂盛', N'当ＨＰ小于1/3时，草属性招式的威力增长为1.5倍。'),
    (N'猛火', N'当ＨＰ小于1/3时，火属性招式的威力增长为1.5倍。'),
    (N'激流', N'当ＨＰ小于1/3时，水属性招式的威力增长为1.5倍。'),
    (N'鳞粉', N'拥有该特性的宝可梦不会受到其他宝可梦招式的追加效果影响；不能防止变化招式（如催眠粉、电磁波）的效果。'),
    (N'蜕皮', N'在每回合结束时，有1/3的几率治愈自身除濒死以外的异常状态。'),
    (N'复眼', N'因为拥有复眼，招式的命中率会提高。'),
    (N'虫之预感', N'ＨＰ减少的时候，虫属性的招式威力会提高。'),
    (N'锐利目光', N'多亏了锐利的目光，命中率不会被降低。'),
    (N'逃跑', N'在与野生宝可梦对战时，无视对手任何阻挡逃走的效果，必定逃走成功。'),
    (N'威吓', N'出场时威吓对手，让其退缩，降低对手的攻击。'),
    (N'静电', N'身上带有静电，有时会让接触到的对手麻痹。'),
    (N'沙隐', N'在沙暴的时候，闪避率会提高。'),
    (N'毒刺', N'受到接触类招式攻击时，攻击方有机会陷入中毒状态。'),
    (N'迷人之躯', N'有时会让接触到自己的对手着迷。'),
    (N'引火', N'受到火属性的招式攻击时，吸收火焰，自己使出的火属性招式会变强。'),
    (N'精神力', N'该特性的宝可梦不会陷入。破格、兆级电压和涡轮火焰特性的宝可梦仍能使该特性的宝可梦畏缩。获得该特性并不能解除畏缩状态；该特性不受威吓影响。'),
    (N'叶绿素', N'处于大晴天或大日照天气时，该特性的宝可梦速度能力变为原来的2倍。'),
    (N'孢子', N'使用接触类招式攻击该特性的宝可梦时会有30%的机率陷入麻痹、中毒或睡眠状态；其中，睡眠概率略高于10%，麻痹概率为10%，中毒概率略低于10%。[https://projectpokemon.org/forums/showthread.php?23700-Beta-the-Pok%E9check-VS.-Player-(battle-video-parser)&p=147302&viewfull=1#post147302 破解代码]。'),
    (N'捡拾', N'当自己没有携带物品时，回合结束后获得在自己的非远程招式攻击范围内，对方宝可梦或同伴宝可梦於該回合使用或投掷而消耗的携带物品。如果回合内对手宝可梦与同伴宝可梦均使用了道具，优先获得对手的道具；同一回合内离场或陷入濒死的宝可梦用掉的道具无法被捡拾，即使在該回合内又重新上场。'),
    (N'湿气', N'当该宝可梦在场时，自爆、大爆炸、惊爆大头和薄雾炸裂会使用失败，引爆特性無效。'),
    (N'干劲', N'该特性的宝可梦不会陷入睡眠状态，另外睡觉招式会无效。'),
    (N'储水', N'受到水属性的招式攻击时，不会受到伤害，而是会回复。'),
    (N'同步', N'将自己的中毒、麻痹或灼伤状态传染给对手。'),
    (N'毅力', N'该特性的宝可梦处于除濒死以外的异常状态时，攻击提升50%，并无视灼伤的非固定伤害类物理招式威力变为原本的50%效果；该特性的宝可梦被冰冻时使用解除冰冻状态的招式，攻击不会提升。'),
    (N'恒净之躯', N'不会因为对手的招式或特性而被降低能力。'),
    (N'坚硬脑袋', N'不会受到自身招式的反作用力伤害。作用范围不包括（可能）按自身最大ＨＰ比例损伤自身的招式；此特性不影响生命宝珠的副作用。'),
    (N'迟钝', N'该特性的宝可梦不会陷入着迷和挑衅状态。陷入此状态的宝可梦获得该特性时此状态消除；该特性不受威吓影响。'),
    (N'磁力', N'用磁力吸住钢属性的宝可梦，使其无法逃走。'),
    (N'早起', N'该特性的宝可梦陷入睡眠的持续回合变为原来的1/2（向下取整）。例如，原本睡眠状态持续3回合时会变为1回合，原本持续1回合时会立刻清醒；对自身使用睡觉而陷入的睡眠状态同样有效。'),
    (N'厚脂肪', N'拥有该特性的寶可夢受到冰属性或火属性招式攻击时，在伤害计算中对方的攻擊或特攻减半；此效果不是能力变化。'),
    (N'恶臭', N'通过释放臭臭的气味，在攻击的时候，有时会使对手畏缩。'),
    (N'硬壳盔甲', N'不会被击中要害，即使是必定命中要害的招式也不會击中要害。'),
    (N'诅咒之躯', N'该特性的宝可梦受到攻击时，有30%几率使目标陷入定身法状态；以下情况时该特性仍能发动。'),
    (N'不眠', N'该特性的宝可梦不会陷入睡眠状态，睡觉招式会无效。陷入睡眠的宝可梦获得该特性时睡眠状态消除。'),
    (N'怪力钳', N'攻击能力变化不会被对方以任何方式降低。'),
    (N'隔音', N'不受其他宝可梦使出的声音类招式影响，但会受到自己使出的声音的招式影响；双打对战中在场上时不能被同伴的治愈铃声治愈。'),
    (N'结实', N'一击必杀的招式对拥有该特性的寶可夢无效；拥有该特性的寶可夢在满ＨＰ状态下受到一次攻击时，至少会保留1点ＨＰ。'),
    (N'无防守', N'由于无防守战术，双方使出的招式都必定会击中。'),
    (N'魔法防守', N'不会受到天气、道具、特性、异常状态、状态变化、除挣扎之外的反作用力伤害的招式等造成的伤害；非伤害效果仍然保留：例如灼伤状态的攻击减半效果，状态的伤害计数增加，生命宝珠对招式威力的增幅作用。'),
    (N'适应力', N'属性一致加成对攻击招式威力的提升从原本的1.5倍提升至2倍；如果具有此特性的宝可梦进行了太晶化，则。'),
    (N'避雷针', N'将电属性的招式吸引到自己身上，不会受到伤害，而是会提高特攻。'),
    (N'柔软', N'该特性的宝可梦不会陷入麻痹状态，陷入麻痹的宝可梦获得该特性时麻痹状态消除。'),
    (N'自然回复', N'回到同行队伍后，异常状态就会被治愈。'),
    (N'天恩', N'使用招式时追加效果的出现率×2，超过100％则必然出现追加效果；携带王者之证或锐利之牙的宝可梦触发道具效果的几率×2。'),
    (N'大力士', N'伤害计算中，此宝可梦的攻击能力值×２；此效果不是能力变化。使用其他数据代替攻击能力值（如将对手的攻击能力值代替自身攻击能力值的欺诈、将自身的防御能力值代替自身攻击能力值的扑击）进行伤害计算的物理招式时，伤害计算中的攻击也会×２。'),
    (N'轻快', N'下雨天气时，速度会提高。'),
    (N'加速', N'持有该特性的宝可梦每回合结束速度上升1级，但該回合交換出持有该特性的宝可梦則不會發動。'),
    (N'斗争心', N'对手与自身性别相同时，招式威力提升25%；性别不同时威力下降25%。双方只要有一方为性别不明时，招式威力不变，群体对战的群体伤害中，多性别仍然为同性威力提升25%，不同性别威力下降25%。'),
    (N'蹒跚', N'對擁有該特性且處於混亂狀態的寶可夢使用招式時，命中率僅為原本的一半。'),
    (N'电气引擎', N'受到电属性的招式攻击时，不会受到伤害，而是速度会提高。'),
    (N'不屈之心', N'该特性的宝可梦陷入畏缩状态后，速度提升1级。'),
    (N'雪隐', N'下雪天气时，闪避率会提高。'),
    (N'贪吃鬼', N'当宝可梦的ＨＰ不大于最大ＨＰ的1/2，而不是通常的1/4时，携带的树果就会被食用。'),
    (N'愤怒穴位', N'当被击中要害时，攻击提升至+6阶级；处于替身状态下的宝可梦，无法发动该特性。'),
    (N'轻装', N'当失去携带物品时速度加倍；輕裝特性发动中，如果获得新的道具、失去轻装特性或者被换下场，则效果消失。'),
    (N'防尘', N'该特性的宝可梦不会受到沙暴和冰雹天气带来的负面影響，對粉末类招式和孢子特性免疫。'),
    (N'魔法镜', N'会反弹多数变化招式，将其效果返还给使用者。'),
    (N'再生力', N'交换下场时，回复自身最大ＨＰ的1/3；如果在特性受到影响时离场，先判定再生力特性的ＨＰ回复再恢复特性。因此，受无特性或特性互换等效果影响而失去再生力特性的宝可梦离场时不回复ＨＰ。通过特性互换或复制获得再生力特性后离场时回复ＨＰ。'),
    (N'恶作剧之心', N'该特性的宝可梦使用变化招式时优先度+1，包括变化招式的Ｚ招式；受此特性影响的招式对对手的恶属性宝可梦无效。'),
    (N'破格', N'拥有该特性的宝可梦使出招式时能够使目标自身、目标同伴以及自身同伴的一部分特性失效；当拥有该特性的宝可梦强制拉对手的备战宝可梦上场时，上场的备战宝可梦的特性不会对场上的毒菱、撒菱和黏黏网状态生效。'),
    (N'分析', N'如果其他所有宝可梦的行动都在自己之前，则自己使用的招式的威力提高30%；如果其他所有宝可梦都是在本回合替换上场的，分析特性也能发动。'),
    (N'砂之力', N'在沙暴天气下，该特性的宝可梦不受沙暴伤害，同时使用的岩石属性、钢属性、地面属性招式威力提升30%。'),
    (N'铁刺', N'受到接触类招式攻击时对手会损失最大体力的1/8；连续招式的每一击都会触发此特性。'),
    (N'神奇鳞片', N'异常状态时防御上升为原来1.5倍。'),
    (N'浮游', N'拥有该特性的宝可梦免疫地面属性招式（除了泼沙和千箭齐发），不会受到沙穴特性和毒菱、撒菱、黏黏网和场地型状态等状态变化的影响。拥有该特性的毒属性的宝可梦无法清除毒菱；当宝可梦持有道具黑色鐵球，或是宝可梦处于击落、扎根状态，或是场地上存在重力状态时，该特性失效。'),
    (N'降雨', N'出场时，会将天气变为下雨。'),
    (N'日照', N'出场时，会将天气变为晴朗。'),
    (N'沙穴', N'在战斗中让对手无法逃走。'),
    (N'白色烟雾', N'被白色烟雾保护着，不会被对手降低能力。'),
    (N'瑜伽之力', N'伤害计算中，此宝可梦的攻击能力值×２；此效果不是能力变化。使用其他数据代替攻击能力值（如将对手的攻击能力值代替自身攻击能力值的欺诈、将自身的防御能力值代替自身攻击能力值的扑击）进行伤害计算的物理招式时，伤害计算中的攻击也会×２。'),
    (N'液态污泥', N'受到吸取HP的招式攻击时，对手不会回复HP，而是损失相应HP。'),
    (N'黏着', N'因为道具是粘在黏性身体上的，所以不会被对手夺走。'),
    (N'活力', N'自己的攻击变高，但命中率会降低。'),
    (N'正电', N'场上己方同伴具有正电或负电特性时，特攻能力×1.5。'),
    (N'负电', N'场上己方同伴具有负电或正电特性时，特攻能力×1.5。'),
    (N'悠游自如', N'下雨天气时，速度会提高。'),
    (N'火焰之躯', N'使用接触类招式攻击该特性的宝可梦时会有30%的机率灼伤；连续招式的每一击都会单独触发该特性。'),
    (N'压迫感', N'给予对手压迫感，大量减少其使用招式的ＰＰ。'),
    (N'蓄电', N'受到电属性的招式攻击时，不会受到伤害，而是会回复。'),
    (N'过滤', N'效果絕佳招式造成的伤害降低1/4。'),
    (N'下载', N'该特性的宝可梦出场时，对手防御小于特防时，自身攻击提升1级；对手防御大于或等于特防时，自身特攻提升1级；在双打对战及三打对战时，用对方所有宝可梦的防御总和与特防总和来计算。'),
    (N'复制', N'自身登场时，复制特性变为随机1只对方宝可梦的特性。如果复制到了登场时发动的特性，它会立即发动。自身离场时特性还原为复制；当复制其他特性后，该特性的宝可梦再次变为复制特性（比如使用扮演），复制特性无法触发，直到下次替换出场时再次触发。'),
    (N'技术高手', N'使用威力小于等于60的招式，威力提升原来的50%。只计算招式自身的效果对威力的影响，不计算道具、特性等其他任何的效果；连续招式按单独每次攻击时威力判断是否触发该特性。'),
    (N'战斗盔甲', N'不会被击中要害，即使是必定命中要害的招式也不会击中要害。'),
    (N'胆怯', N'该特性的宝可梦受到恶属性、幽灵属性和虫属性属性招式攻击时，速度提升1级。对于恶属性、幽灵属性和虫属性连续招式，每次攻击都能触发该特性；受到威吓影响，该特性的宝可梦速度提升1级。'),
    (N'湿润之躯', N'该特性的宝可梦在下雨时，该回合最后会解除所有异常状态；处于瞌睡状态的该特性宝可梦，由于回合结束时，先触发湿润之躯，因此在下雨时也会进入睡眠，睡眠后的下一回合若还在下雨，则可触发湿润之躯解除睡眠。')
